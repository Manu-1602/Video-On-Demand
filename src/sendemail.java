...
public class sendemail 
{
    ...
    String port = "587";
    String mailFrom = "bhaveshuppal2002@gmail.com";
   // String password = "nrfgahxkkacqdvux";
    String password="gzok hdlf cilb gnbz";
//    ybluldcqbdztjzjp
...
//            msg.setText(message);
    ...
    //  String otp =  (int) (1000+(9999-1000)*Math.random())+"";
        //    sendemail obj = new sendemail("taniaahuja.2389@gmail.com","hello","Your Otp is: "+otp);
    //}
}
